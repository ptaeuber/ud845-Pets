...
//                displayDatabaseInfo();
    ...
    private void deleteAllPets() {
        ...
        if (rowsDeleted != 0) {
            Toast.makeText(this, R.string.editor_delete_pets_successful, Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(this, R.string.editor_delete_pets_failed, Toast.LENGTH_LONG).show();
        }
    }
}
